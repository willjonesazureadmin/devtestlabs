...
function RunCommand
{
    ...
    # Run custom command for this artifact.
       ...
       Set-AzVMExtension -Publisher "Microsoft.Azure.ActiveDirectory" -Name "AADLoginForWindows" -ResourceGroupName $vm.compute.resourceGroupName -VMName $vm.compute.name -ExtensionType "AADLoginForWindows" -Location $vm.compute.location -TypeHandlerVersion 1.0 -AsJob
}
